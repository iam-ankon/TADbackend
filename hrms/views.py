...
class CVAddViewSet(viewsets.ModelViewSet):
    ...
    def update_cv_with_qr(self, request, pk=None):
        try:
            ...
            if 'qr_temp' in locals() and os.path.exists(qr_temp.name):
